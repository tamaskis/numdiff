#[cfg(feature = "faer")]
use faer_traits::{
    ComplexField, RealField, SimdCapabilities, pulp::Scalar as FaerScalar, pulp::Simd,
};
#[cfg(feature = "ndarray")]
...
// -----------------------------------------------
// Implementing faer_traits::RefOps for HyperDual.
// -----------------------------------------------
...
impl<'a> Add<&'a HyperDual> for HyperDual {
    type Output = HyperDual;
    fn add(self, rhs: &'a HyperDual) -> HyperDual {
        self + *rhs
    }
}
...
impl<'a> Sub<&'a HyperDual> for HyperDual {
    type Output = HyperDual;
    fn sub(self, rhs: &'a HyperDual) -> HyperDual {
        self - *rhs
    }
}
...
impl<'a> Mul<&'a HyperDual> for HyperDual {
    type Output = HyperDual;
    fn mul(self, rhs: &'a HyperDual) -> HyperDual {
        self * *rhs
    }
}
...
impl<'a> Div<&'a HyperDual> for HyperDual {
    type Output = HyperDual;
    fn div(self, rhs: &'a HyperDual) -> HyperDual {
        self / *rhs
    }
}

impl<'a> Add<HyperDual> for &'a HyperDual {
    type Output = HyperDual;
    fn add(self, rhs: HyperDual) -> HyperDual {
        *self + rhs
    }
...
impl<'a> Sub<HyperDual> for &'a HyperDual {
    type Output = HyperDual;
    fn sub(self, rhs: HyperDual) -> HyperDual {
        *self - rhs
    }
...
impl<'a> Mul<HyperDual> for &'a HyperDual {
    type Output = HyperDual;
    fn mul(self, rhs: HyperDual) -> HyperDual {
        *self * rhs
    }
...
impl<'a> Div<HyperDual> for &'a HyperDual {
    type Output = HyperDual;
    fn div(self, rhs: HyperDual) -> HyperDual {
        *self / rhs
    }
...
impl<'a, 'b> Add<&'b HyperDual> for &'a HyperDual {
    type Output = HyperDual;
    fn add(self, rhs: &'b HyperDual) -> HyperDual {
        *self + *rhs
    }
}
...
impl<'a, 'b> Sub<&'b HyperDual> for &'a HyperDual {
    type Output = HyperDual;
    fn sub(self, rhs: &'b HyperDual) -> HyperDual {
        *self - *rhs
    }
}
...
impl<'a, 'b> Mul<&'b HyperDual> for &'a HyperDual {
    type Output = HyperDual;
    fn mul(self, rhs: &'b HyperDual) -> HyperDual {
        *self * *rhs
    }
}
...
impl<'a, 'b> Div<&'b HyperDual> for &'a HyperDual {
    type Output = HyperDual;
    fn div(self, rhs: &'b HyperDual) -> HyperDual {
        *self / *rhs
    }
}

impl<'a> AddAssign<&'a HyperDual> for HyperDual {
    fn add_assign(&mut self, rhs: &'a HyperDual) {
        *self += *rhs;
    }
}

impl<'a> SubAssign<&'a HyperDual> for HyperDual {
    fn sub_assign(&mut self, rhs: &'a HyperDual) {
        *self -= *rhs;
    }
}

impl<'a> MulAssign<&'a HyperDual> for HyperDual {
    fn mul_assign(&mut self, rhs: &'a HyperDual) {
        *self *= *rhs;
    }
}

impl<'a> DivAssign<&'a HyperDual> for HyperDual {
    fn div_assign(&mut self, rhs: &'a HyperDual) {
        *self /= *rhs;
    }
}
...
#[cfg(feature = "faer")]
impl ComplexField for HyperDual {
...
// --------------------------------------------------
// Implementing faer_traits::RealField for HyperDual.
// --------------------------------------------------
// NOTE: This is required for implementing linalg_traits::Scalar.

#[cfg(feature = "faer")]
impl RealField for HyperDual {
    #[inline(always)]
...
// --------------------------------------------------
// Implementing ndarray::ScalarOperand for HyperDual.
// --------------------------------------------------
// NOTE: This is required for implementing linalg_traits::Scalar.

#[cfg(feature = "ndarray")]
impl ScalarOperand for HyperDual {}
