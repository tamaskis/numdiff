...
/// let v = vec![10.0, 20.0];
///
/// let df_v: f64 = directional_derivative(&f, &x0, &v, Some(0.000001));
/// let df_v_true: f64 = 31250.0 + 60.0 * 8.0_f64.sin().powi(2) * 8.0_f64.cos();
///
/// assert_equal_to_decimal!(df_v, df_v_true, 1);
/// ```
